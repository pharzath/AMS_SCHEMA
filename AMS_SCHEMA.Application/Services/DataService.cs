...
namespace AMS.Model.Services
{
	public class DataService : IDisposable
	{
		...
		{
			return _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey<AmsNeo4JNodeConstraint>(nameof(GetNodeConstraints)), _ =>
			{
		...
		public async Task SaveLabel(AmsNeo4JNodeLabel label)
		{
			...
			_cacheProvider.ExpireCachKeys(label);
		}

		public List<AmsNeo4JNodeRelationType>? GetRelationTypes()
		{
			return _cacheProvider.GetOrCreate(_cacheProvider.CreateCachKey<AmsNeo4JNodeRelationType>(nameof(GetRelationTypes)), _ =>
			{
		...
		public void SaveRelation(AmsNeo4JNodeRelation nodeRelation)
		{
			...
			_cacheProvider.ExpireCachKeys(nodeRelation);
		}
		...
		{
			var nodes = _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey<AmsNeo4JNode>(nameof(GetNodes)),
				_ =>
				{
		...
		public void SaveConstraint(AmsNeo4JNodeConstraint constraint)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(constraint);
		}
		...
		public void DeleteLabel(AmsNeo4JNodeLabel lbl)
		{
			...
			try
			{
				...
				_cacheProvider.ExpireCachKeys(lbl);
		...
		public void DeleteRelation(AmsNeo4JNodeRelation relation)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(relation);
		}

		public List<AmsNeo4JNodeDepartment> GetNodeDepartment(AmsNeo4JNode node)
		{
			var list = _cacheProvider.GetOrCreate(_cacheProvider.CreateCachKey(nameof(GetNodeDepartment), node), _ =>
			{
		...
		{
			var list = _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey<AmsNeo4JDepartment>(nameof(GetDepartments), SelectedProject?.Id ?? 0), _ =>
				{
		...
		public void AddDepartmentToNode(AmsNeo4JNode node, AmsNeo4JDepartment amsmoduleDepartment)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(node);
			_cacheProvider.ExpireCachKeys(amsmoduleDepartment);
		}
		...
		public void DeleteDepartmentFromNode(AmsNeo4JNodeDepartment context)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(context);
		}
		...
		public void SaveLabelProperty(AmsNeo4JNodeLabelProperty prop)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(prop);
		}
		...
		public List<AmsNeo4JNodeIndex> GetNodeIndices(List<AmsNeo4JNodeLabel> labels)
		{
			...
			var list = _cacheProvider.GetOrCreate(_cacheProvider.CreateCachKey<AmsNeo4JNodeLabel>(nameof(GetNodeIndices)), _ =>
			{
		...
		public void SaveIndex(AmsNeo4JNodeIndex index)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(index);
		...
		{
			var list = _cacheProvider.GetOrCreate(_cacheProvider.CreateCachKey<AmsNeo4JNodeRelation>(nameof(GetRelations), typeof(AmsNeo4JNodeLabel)), _ =>
			{
				return DbContext
		...
		public void SaveRelationType(AmsNeo4JNodeRelationType relationType)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(relationType);
		}
		...
		public void SaveRelationTypeProperty(AmsNeo4JNodeRelationProperty property)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(property);
		...
		{
			//var list = _cacheProvider.GetOrCreate(_cacheProvider.CreateCachKey(nameof(GetParentLabelsAndThis), label, typeof(AmsNeo4JNodeLabel)),
		...
		{
			var list = _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey<AmsNeo4JNodeLabel>(nameof(GetLabels), SelectedProject?.Id ?? 0),
				_ =>
				{
		...
		{
			var properies = _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey<AmsNeo4JNodeLabelProperty>(nameof(GetLabelProperties), labelId),
				_ =>
				{
		...
		{
			var queries = _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey(nameof(GetNodeQueries), label),
				_ =>
				{
		...
		public void SaveLabelQuery(AmsNeo4JNodeLabelQuery query)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(query);
		}
		...
		{
			return _cacheProvider.GetOrCreate(_cacheProvider.CreateCachKey<AmsNeo4JNodeLabelRequiredRelation>(nameof(GetLabelRequires)),
				_ =>
				{
		...
		public void SaveProject(AmsNeo4JProject project)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(project);
		}
		...
		public void SaveMicroservice(AmsNeo4JMicroservice microservice)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(microservice);
		}
		...
		public void SaveMicroserviceModule(AmsNeo4JMicroserviceModule microserviceModule)
		{
			...
			DbContext.SaveChanges();
			_cacheProvider.ExpireCachKeys(microserviceModule);
		}

		public IQueryable<AmsNeo4JMicroservice>? GetMiroservices(int projectFk)
		{
			return _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey<AmsNeo4JMicroservice>(nameof(GetMiroservices) + projectFk),
				_ =>
				{
		...
		public IQueryable<AmsNeo4JMicroserviceModule>? GetMiroserviceModules(int msFk)
		{
			...
			return _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey<AmsNeo4JMicroserviceModule>(nameof(GetMiroserviceModules) + msFk),
				_ =>
				{
		...
		public List<AmsNeo4JMicroserviceModuleSetting>? GetLabelModuleSettings(int labelId, int? moduleId)
		{
			...
			return _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey<AmsNeo4JMicroserviceModule>(nameof(GetLabelModuleSettings) + labelId + "-" + moduleId),
				_ =>
				{
		...
		{
			return _cacheProvider.GetOrCreate(
				_cacheProvider.CreateCachKey<AmsNeo4JMicroserviceModuleSettingDefault>(nameof(GetMicroserviceModuleSettingDefaults) + module.Id),
				_ =>
				{
