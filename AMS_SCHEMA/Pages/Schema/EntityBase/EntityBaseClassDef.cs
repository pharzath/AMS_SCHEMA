...
namespace AMS_SCHEMA.Pages.Schema.EntityBase
{
    public class EntityBaseClassDef
    {
        ...
        public static IEnumerable<AmsNeo4JNodeLabelPropery> GetEntityBaseProperties()
        {

            IEnumerable<AmsNeo4JNodeLabelPropery> props = EntityBaseClassDef.PropertiesDict
